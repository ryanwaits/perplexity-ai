...
Perplexity is simple [perplexity.ai](https://www.perplexity.ai/) clone. Use the code for whatever you like! :)

If you have any questions, feel free to reach out to me on [Twitter](https://twitter.com/mckaywrigley).

[![Perplexity AI](./public/screenshot.png)](https://perplexity-ai.vercel.app/)

## How It Works

Given a query, Perplexity fetches relevant, up-to-date information from the web and uses OpenAI's API to generate an answer.
...
```bash
git clone https://github.com/mckaywrigley/perplexity-ai.git
```
...
Here are some ideas for how to improve Perplexity:
...
LLMs are amazing, and I hope Perplexity inspires you to build something cool!
